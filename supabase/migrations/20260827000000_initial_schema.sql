...
create table if not exists public.pkm_profiles (
...
create table if not exists public.household_cards (
  id uuid primary key default gen_random_uuid(),
...
drop policy if exists "officers see their own entries" on public.household_entries;
...
drop policy if exists "officers create own entries" on public.household_entries;
...
drop policy if exists "officers see their household cards" on public.household_cards;
...
drop policy if exists "officers create cards for own entries" on public.household_cards;
